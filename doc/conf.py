# -*- coding: utf-8 -*-
#
# apptemplate documentation build configuration file, created by
...
version = '%(major)s.%(minor)s.%(patch)s' % VERSION_INFO
...
texinfo_documents = [
  ('index', project, project + u' Documentation',
   author, project, short_description, 'Miscellaneous'),
]
